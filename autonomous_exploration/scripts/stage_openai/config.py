...
class Config():
    ...
    def __init__(self):
        ...
        parser.add_argument('--num_states', type=int, default=15, help='num states (fixed)')
        parser.add_argument('--MAX_STEPS', type=int, default=5, help='num steps for episode)')
        parser.add_argument('--NUM_EPISODES', type=int, default=2000, help='num episodes')
        parser.add_argument('--TOTAL_EPISODES', type=int, default=2000, help='Total episodes')
